...
function adicionar_html_condicional($content) {
    if (is_single() && get_post_type() == 'post') {
        ...
        $content .= '<div class="has-background gpbr-custom-blog-block"><p>Sem a ajuda de pessoas como você, nosso trabalho não seria possível. O Greenpeace Brasil é uma organização independente - não aceitamos recursos de empresas, governos ou partidos políticos. Por favor, faça uma doação hoje mesmo e nos ajude a ampliar nosso trabalho de pesquisa, monitoramento e denúncia de crimes ambientais. Clique abaixo e faça a diferença!</p><div class="wp-block-buttons is-content-justification-center is-layout-flex wp-container-2"><div class="wp-block-button"><a href="https://doe.greenpeace.com.br/?cc=701Pm00000DisbVIAR&entrypoint=blog_donation_block" class="wp-block-button__link wp-element-button">Doe agora</a></div></div></div>
        <style>
