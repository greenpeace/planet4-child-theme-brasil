...
function adicionar_html_condicional($content) {
    if (is_single() && get_post_type() == 'post') {
        ...
        $content .= '<div class="has-background gpbr-custom-blog-block"><p>A região Amazônica está vivendo uma seca histórica, que mostra a gravidade dos eventos climáticos extremos. E milhares de pessoas estão sentindo os efeitos deste desastre na pele. Por isso, o Greenpeace retomou a campanha Asas da Emergência e já levou toneladas de alimentos e outros itens essenciais para as comunidades mais afetadas. Agora, precisamos do seu apoio para chegar mais longe. Por favor, faça uma doação emergencial.</p><div class="wp-block-buttons is-content-justification-center is-layout-flex wp-container-2"><div class="wp-block-button"><a href="https://doe.greenpeace.org.br/emergencia-amazonia/p?entrypoint=p4_customblock" class="wp-block-button__link wp-element-button">Doe agora</a></div></div></div>
